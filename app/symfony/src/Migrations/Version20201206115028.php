 ...
 */
final class Version20201206115028 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, quotation_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, code VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D34A04AD77153098 (code), INDEX IDX_D34A04AD12469DE2 (category_id), INDEX IDX_D34A04ADB4EA4E60 (quotation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quotation (id INT AUTO_INCREMENT NOT NULL, deadline_id INT DEFAULT NULL, client_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description TINYTEXT DEFAULT NULL, quotation_date DATE NOT NULL, reference VARCHAR(255) DEFAULT NULL, payment VARCHAR(255) DEFAULT NULL, amount DOUBLE PRECISION DEFAULT NULL, total_ht DOUBLE PRECISION DEFAULT NULL, quantity DOUBLE PRECISION DEFAULT NULL, designation VARCHAR(255) DEFAULT NULL, status TINYINT(1) DEFAULT NULL, deposit DOUBLE PRECISION DEFAULT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, address VARCHAR(125) NOT NULL, city VARCHAR(125) NOT NULL, country VARCHAR(125) NOT NULL, postal_code VARCHAR(16) NOT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_474A8DB973EA0AF8 (deadline_id), INDEX IDX_474A8DB919EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADB4EA4E60 FOREIGN KEY (quotation_id) REFERENCES quotation (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04ADB4EA4E60');
