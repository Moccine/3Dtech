 ...
 */
final class Version20201213142527 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, street VARCHAR(125) DEFAULT NULL, city VARCHAR(12) DEFAULT NULL, country VARCHAR(125) DEFAULT NULL, postal_code VARCHAR(16) DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, company VARCHAR(255) DEFAULT NULL, first_name VARCHAR(125) NOT NULL, last_name VARCHAR(125) NOT NULL, mobile_phone VARCHAR(50) NOT NULL, home_phone VARCHAR(50) DEFAULT NULL, siret VARCHAR(255) DEFAULT NULL, type VARCHAR(50) NOT NULL, street VARCHAR(125) DEFAULT NULL, city VARCHAR(12) DEFAULT NULL, country VARCHAR(125) DEFAULT NULL, postal_code VARCHAR(16) DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_C7440455A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quotation_line (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, unit_price DOUBLE PRECISION DEFAULT NULL, discount DOUBLE PRECISION DEFAULT NULL, total_ht DOUBLE PRECISION DEFAULT NULL, amount DOUBLE PRECISION DEFAULT NULL, deposit DOUBLE PRECISION DEFAULT NULL, quantity INT DEFAULT NULL, UNIQUE INDEX UNIQ_4CE011BA4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
