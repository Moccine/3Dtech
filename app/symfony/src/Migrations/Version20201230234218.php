 ...
 */
final class Version20201230234218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_474A8DB973EA0AF8 ON quotation (deadline_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_474A8DB973EA0AF8 ON quotation');
